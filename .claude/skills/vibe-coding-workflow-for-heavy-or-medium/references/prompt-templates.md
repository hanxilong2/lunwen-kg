# Prompt Templates — Heavy/Medium

Use these templates for heavy or medium projects that need the full document-driven,
multi-agent workflow. Adapt names, commands, and file paths to the repository.
For small features or scripts, use the lighter templates in vibe-coding-workflow-for-light.
...
When tasks are independent, dispatch them to sub-agents in parallel to reduce wall-clock time.
